...
Rails.application.configure do
  config.content_security_policy do |policy|
    ...
    policy.script_src :self, "https://*.argyle.com", "https://js-agent.newrelic.com", "https://*.nr-data.net", "https://dap.digitalgov.gov", "https://www.google-analytics.com", "https://cdn.getpinwheel.com"
