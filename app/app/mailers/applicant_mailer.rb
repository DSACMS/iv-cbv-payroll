class ApplicantMailer < ApplicationMailer
  ...
  def invitation_email
    mail(
      ...
      subject: view_context.client_agency_translation("applicant_mailer.invitation_email.subject")
    )
  end
  ...
  def invitation_reminder_email
    mail(
      to: @cbv_flow_invitation.email_address,
      subject: view_context.client_agency_translation("applicant_mailer.invitation_reminder_email.subject")
    )
  end
