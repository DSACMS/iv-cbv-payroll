module E2e
  module TestHelpers
    ...
    def verify_page(page, title:, wait: Capybara.default_max_wait_time, skip_axe_rules: [], skip_axe: false)
      wait_for_idle(page)
      ...
      expect(page).to be_axe_clean.skipping(skip_axe_rules) unless skip_axe
    end
