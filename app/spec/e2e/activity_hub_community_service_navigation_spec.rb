...
RSpec.describe "e2e Community Service self-attestation navigation", :js, type: :feature do
  ...
  def fill_org_info(org_name: "Test Org")
    fill_in I18n.t("activities.community_service.organization_name"), with: org_name
  ...
  def fill_month_hours(month_label, hours:)
    fill_in I18n.t("activities.community_service.hours_input.hours_label", month: month_label), with: hours
  end
  ...
  it "back and exit buttons work correctly through creation, edit-from-review, and edit-from-hub flows" do # rubocop:disable RSpec/ExampleLength,RSpec/MultipleExpectations
    ...
    verify_page(page, title: I18n.t("activities.community_service.hours_input.heading",
      month: month1_label, organization: "Nav Test Org"))
    expect_exit_button
    ...
    expect(find_field(I18n.t("activities.community_service.organization_name")).value).to eq "Nav Test Org"
    expect(find_field(I18n.t("activities.community_service.street_address")).value).to eq "123 Main St"
    ...
    verify_page(page, title: I18n.t("activities.community_service.hours_input.heading",
      month: month2_label, organization: "Nav Test Org"))
    expect_exit_button
    expect_back_button(visible: true)
    ...
    expect(find_field(I18n.t("activities.community_service.hours_input.hours_label", month: month1_label)).value).to eq "20"
    ...
    verify_page(
      page,
      title: I18n.t("activities.document_uploads.new.title", name: "Nav Test Org"),
    ...
    expect(find_field(I18n.t("activities.community_service.hours_input.hours_label", month: month2_label)).value).to eq "10"
    ...
    verify_page(page, title: I18n.t("activities.community_service.review.title", organization_name: "Nav Test Org"))
    expect_exit_button
    expect_back_button(visible: true)
    ...
    # --- Edit org info from review (back should go to review) ---
    ...
    # --- Edit org info and save — should return to review ---
    edit_links = all("a", text: I18n.t("activities.hub.edit"))
    edit_links.first.click
    verify_page(page, title: I18n.t("activities.community_service.edit_title"))
    ...
    # --- Edit org info from review in edit flow ---
    edit_links = all("a", text: I18n.t("activities.hub.edit"))
    edit_links.first.click
