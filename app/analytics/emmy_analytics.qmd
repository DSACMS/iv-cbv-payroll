...
default_caption <- "Source: Lousiana 2025 EMMY Pilot Mixpanel Data [accessed 2025-12-19]"
...
For the Louisana pilot, applicants were both mailed paper notices and sent an SMS with a notice about the pilot. We can investigate whether there is any difference in completion rates based on how the applicants are accessing the app.
...
3.  when no `origin` parameter is used, MixPanel interprets this as the "default origin", which is agency configured and set it to "sms" for the Lousiana pilot.
:::
