...
We can see how this places our when comparing different payroll aggregators used, Argyle and Pinwheel. Each pilot we can see there is a signficant gap between the time it takes to sync with Pinwheel versus Argyle. 
