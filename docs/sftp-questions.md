...
* What is the lead time like to get such a bucket? (If lead time is measured in months, is there anything we can do to expedite the proces?)
Is any security review/documentation necessary beyond the standard DSA? (Please send us the form.)
If we upload files [in this format](https://app.box.com/file/1817504471038), is that acceptable?