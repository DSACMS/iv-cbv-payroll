...
For a full list of rationale and factors, see [ADR: Separate app infrastructure into layers](/cbv/docs/decisions/infra/0009-separate-app-infrastructure-into-layers.md).
