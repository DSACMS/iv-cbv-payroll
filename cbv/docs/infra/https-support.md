...
In order to set up HTTPS support you'll also need to have [set up custom domains](/cbv/docs/infra/set-up-custom-domains.md). This is because SSL/TLS certificates must be properly configured for the specific domain to support establishing secure connections.
